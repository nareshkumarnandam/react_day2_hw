...
const topic1 = React.createElement('p', {className: "topic"} , 'Getting started with the web');
...
const topic2 = React.createElement('p' , {className: "topic"} , 'HTML - Structuring the web');
...
const topic3 = React.createElement('p' , {className: "topic"} , 'CSS - Styling the web');
